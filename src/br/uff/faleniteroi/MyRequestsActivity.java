...
public class MyRequestsActivity extends FragmentActivity implements 
	...
	private void initialiseTabHost() {
		...
		tabHost.addTab(tabHost.newTabSpec("Tab1").setIndicator("Últimas"), TabRequestLatestFragment.class, null);
		tabHost.addTab(tabHost.newTabSpec("Tab2").setIndicator("Em análise"), TabRequestsUnderAnalysisFragment.class, null);
		tabHost.addTab(tabHost.newTabSpec("Tab3").setIndicator("Concluídas"), TabRequestFinishedFragment.class, null);
	...
	public boolean onQueryTextChange(String query) {
		...
		if (query.trim().equals("")) {
	    	...
	    	tvSearchInfo.setText(itens.size() == 0 ? "Nenhuma solicitação encontrada" : "Resultados da busca");
